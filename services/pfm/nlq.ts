...
export function looksLikePFMQuestion(text: string): boolean {
  ...
  // Action verbs — these are commands to DO something, not analytics questions.
  // If any action verb is present, this is NOT a PFM query.
  const actionVerbs = [
    'оплати', 'оплатить', 'закажи', 'заказать',
    'перейди', 'перейти', 'открой', 'открыть',
    'нажми', 'нажать', 'пополни', 'пополнить',
    'переведи', 'перевести', 'отправь', 'отправить',
    'покажи страницу', 'сделай', 'заполни', 'заполнить',
    'выпиши', 'подай заявку', 'оформи', 'оформить',
    'закинь', 'кинь', 'скинь', 'брось', 'положи',
  ];
  if (actionVerbs.some((v) => t.includes(v))) return false;
  ...
  const keywords = [
    ...
    'по месяц', 'доход', 'кэшфлоу', 'нетто',
    'связ', 'мобильн', 'интернет',
    'мтс', 'билайн', 'beeline', 'megafon', 'мегафон', 'tele2', 'теле2', 'ростелеком', 'rostelecom', 'yota', 'йота',
    'январ', 'феврал', 'март', 'апрел', 'июн', 'июл', 'август', 'сентябр', 'октябр', 'ноябр', 'декабр',
  ];
